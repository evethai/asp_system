        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtworkId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserNofitication_Artwork_ArtworkId1",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserNofitication_Notification_NotificationId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNofitication_ArtworkId1",
                table: "UserNofitication",
                column: "ArtworkId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserNofitication_NotificationId1",
                table: "UserNofitication",
